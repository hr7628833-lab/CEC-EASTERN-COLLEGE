  ...
  return (
    <div id={cardId} className="w-full max-w-sm mx-auto mb-6">
      ...
      <div className="bg-white rounded-2xl shadow-md hover:shadow-2xl transition overflow-hidden flex flex-col relative">
        <button
          onClick={toggleLike}
          className="absolute top-3 right-3 z-10 bg-white/90 p-2 rounded-full shadow-md hover:bg-gray-100"
        >
          <Heart
            className={`w-6 h-6 ${
        ...
        {image && (
          <img
            src={image}
            alt={title}
            className="w-full h-48 object-cover hover:scale-105 transition-transform duration-200 rounded-t-2xl"
          />
        )}
        ...
        <div className="p-4 flex flex-col">
          ...
          <div className="flex justify-between items-center text-sm border-t pt-3">
            ...
            <button
              ...
              className="relative px-4 py-2 text-sm uppercase tracking-wider text-gray-900 group"
            >
              <span>Read More</span>
      ...
      {detailOpen && (
        <div className="fixed inset-0 bg-white z-40 flex flex-col mt-16">
          ...
          <div className="flex-1 overflow-y-auto p-6">
            ...
            <p className="text-gray-500 mb-4 max-w-4xl mx-auto">
              {organization}
            </p>
